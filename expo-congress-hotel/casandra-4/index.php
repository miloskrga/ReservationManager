                                            ...
                                            <div class='container'>
                                                <div class='current-object-content'>
                                                    ...
                                                    <div class='wrapper-object-image'>
                                                        ...
                                                        $query_select_photos = 'SELECT * FROM photo INNER JOIN subobject ON photo.SubObjectId = subobject.SubObjectId WHERE subobject.SubObjectId = 7';
                                                        ...
                                                        {
                                                            $query_select_subobject = 'SELECT * FROM subobject WHERE SubObjectId = 7';
                                                    ...
                                                    <div class='wrapper-object-description'>
                                                        <div class='container'>
                                                            ...
                                                            <div class='row'>
                                                        <?php
                                                            $query_select_equipment = 'SELECT equipment.EquipmentId, equipment.EquipmentName, equipment.equipment_image FROM equipment  INNER JOIN subobjequipment ON equipment.EquipmentId=subobjequipment.EquipmentId INNER JOIN subobject ON subobjequipment.SubObjectId=subobject.SubObjectId WHERE subobject.SubObjectId= 7';
                                                ...
                                                <div class='wrapper-user-comments'>
                                                    ...
                                                    if(isset($_SESSION['id_user']))
                                                    {
                                                        ...
                                                        <div class='form-class'>
                                                            ...
                                                            <button type='button' onclick='leaveComment(7);'>Send</button>
                                                    ...
                                                    <?php
                                                        ...
                                                        $query = 'SELECT * FROM userobjectrating INNER JOIN user ON userobjectrating.UserId = user.UserId WHERE SubObjectId = 7';
