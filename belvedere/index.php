                            ...
                            $query_select_object = 'SELECT * FROM `object` INNER JOIN city ON `object`.CityId = city.CityId INNER JOIN country ON city.CountryId = country.CountryId INNER JOIN objecttype ON `object`.ObjectTypeId = objecttype.ObjectTypeId WHERE ObjectId = 48';
                                            ...
                                            <div class='current-object-content'>
                                                ...
                                                <div class='wrapper-sub-objects'>
                                                    ...
                                                    <?php
                                                        ...
                                                        $query_select_sub_object = 'SELECT * FROM `subobject` INNER JOIN object ON `subobject`.ObjectId = `object`.ObjectId WHERE subobject.ObjectId = 48';
