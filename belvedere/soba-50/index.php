                                            ...
                                            <div class='container'>
                                                <div class='current-object-content'>
                                                    ...
                                                    <div class='wrapper-object-image'>
                                                        ...
                                                        $query_select_photos = 'SELECT * FROM photo INNER JOIN subobject ON photo.SubObjectId = subobject.SubObjectId WHERE subobject.SubObjectId = 98';
                                                        ...
                                                        {
                                                            $query_select_subobject = 'SELECT * FROM subobject WHERE SubObjectId = 98';
                                                ...
                                                <div class='wrapper-user-comments'>
                                                    ...
                                                    if(isset($_SESSION['id_user']))
                                                    {
                                                        ...
                                                        <div class='form-class'>
                                                            ...
                                                            <button type='button' onclick='leaveComment(98);'>Send</button>
                                                    ...
                                                    <?php
                                                        ...
                                                        $query = 'SELECT * FROM userobjectrating INNER JOIN user ON userobjectrating.UserId = user.UserId WHERE SubObjectId = 98';
